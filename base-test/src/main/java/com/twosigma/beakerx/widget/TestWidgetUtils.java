...
import static com.twosigma.beakerx.widget.WidgetInfo.DISPLAY;
import static com.twosigma.beakerx.widget.WidgetInfo.METHOD;
...
public class TestWidgetUtils {
  ...
  public static void verifyOpenCommMsg(List<Message> messages, String modelNameValue,
    ...
    verifyInternalOpenCommMsgWitLayout(messages, modelNameValue, viewNameValue,
            ...
            WidgetInfo.MODEL_MODULE_VALUE,
            WidgetInfo.VIEW_MODULE_VALUE);
  }
  ...
  public static void verifyOpenCommMsgWitoutLayout(List<Message> messages, String modelNameValue,
    ...
    assertThat(data.get(WidgetInfo.MODEL_NAME)).isEqualTo(modelNameValue);
    assertThat(data.get(WidgetInfo.VIEW_NAME)).isEqualTo(viewNameValue);
  }
  ...
  public static void verifyInternalOpenCommMsgWitLayout(List<Message> messages,
    ...
    verifyInternalOpenCommMsgWitLayout(messages, modelNameValue, viewNameValue,
            BeakerxWidgetInfo.MODEL_MODULE_VALUE, BeakerxWidgetInfo.VIEW_MODULE_VALUE);
  }
  ...
  public static void verifyInternalOpenCommMsgWitLayout(List<Message> messages,
    ...
    assertThat(data.get(LayoutInfo.LAYOUT))
            .isEqualTo(LayoutInfo.IPY_MODEL + layout.getContent().get(Comm.COMM_ID));
    assertThat(data.get(WidgetInfo.MODEL_NAME)).isEqualTo(modelNameValue);
    assertThat(data.get(WidgetInfo.VIEW_NAME)).isEqualTo(viewNameValue);
  }
