...
public abstract class ClasspathAddDynamicMagicCommandTest extends KernelSetUpFixtureTest {
  ...
  public ClasspathAddDynamicMagicCommandTest(KernelRunner kernelRunner) {
    super(kernelRunner);
  }
  ...
  public void handleDynamicMagics() throws InterruptedException {
    ...
    Message magicMessage = MessageFactoryTestMock.createExecuteRequestMessage(magicCode);
  ...
  private void runCode(String code) throws InterruptedException {
    Message message = MessageFactoryTestMock.createExecuteRequestMessage(code);
