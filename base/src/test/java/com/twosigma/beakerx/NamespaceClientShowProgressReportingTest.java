...
public class NamespaceClientShowProgressReportingTest {
  ...
  @Before
  public void setUp() {
    namespaceClient = new NamespaceClient(new AutotranslationServiceTestMock(), new DefaultBeakerXJsonSerializer(), new BeakerXCommRepositoryMock());
  ...
  public void updateProgressReporting() throws Exception {
    //given
    SimpleEvaluationObject code = new SimpleEvaluationObject("code", new KernelTest.SeoConfigurationFactoryMock(kernel, commMsg(), MessageCreator.get(), new MagicCommandConfigurationMock()));
