...
public class OutputWidgetTest {
  ...
  private Message submitCodeToExecution() {
    ...
    SimpleEvaluationObject value = new SimpleEvaluationObject("output", new KernelTest.SeoConfigurationFactoryMock(groovyKernel, jupyterMessage, MessageCreator.get(), new MagicCommandConfigurationMock()));
