...
public class BeakerxWidgetTest {
  ...
  private void verifyOpenCommMsgBeakerxWidget(List<Message> messages, String modelNameValue, String viewNameValue) {
    ...
    assertThat(data.get(Widget.MODEL_MODULE)).isEqualTo(BeakerxWidgetInfo.MODEL_MODULE_VALUE);
    assertThat(data.get(Widget.VIEW_MODULE)).isEqualTo(BeakerxWidgetInfo.VIEW_MODULE_VALUE);
