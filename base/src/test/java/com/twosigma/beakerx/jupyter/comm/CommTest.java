...
public class CommTest {
  ...
  private Message submitCodeToExecution() {
    ...
    SimpleEvaluationObject value = new SimpleEvaluationObject("ok", new KernelTest.SeoConfigurationFactoryMock(kernel, jupyterMessage, MessageCreator.get(), new MagicCommandConfigurationMock()));
