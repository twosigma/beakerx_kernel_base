...
public class ExecuteRequestHandlerMagicCommandTest {
  ...
  public static final String DEMO_FILES_DEMO_RESOURCES_BEAKER_XCLASSPATH_TEST_JAR = "./src/test/resources/" + BEAKERX_CLASSPATH_TEST_JAR;
  public static final String DEMO_JAR = "demo.jar";
  public static final String DEMO_FILES_DEMO_RESOURCES_BEAKERX_TEST_LIBRARY_JAR = "./src/test/resources/" + DEMO_JAR;
  ...
  public void setUp() {
    ...
    kernel = new KernelTest("sid", evaluator, MessageCreator.get(), new MagicCommandConfigurationMock());
  ...
  public void handleMagicClasspathAddJarAndExecuteTheCode() throws InterruptedException {
    ...
    Message magicMessage = MessageFactoryTestMock.createExecuteRequestMessage(code);
    //when
  ...
  public void handleMagicJavaScriptCommand() throws Exception {
    ...
    Message magicMessage = MessageFactoryTestMock.createExecuteRequestMessage(JAVASCRIPT + jsCode);
    //when
    executeRequestHandler.handle(magicMessage);
    //then
    Optional<Message> result = waitForResult(kernel);
