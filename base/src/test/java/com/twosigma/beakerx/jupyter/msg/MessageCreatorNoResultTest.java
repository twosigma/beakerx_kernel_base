...
public class MessageCreatorNoResultTest {
  ...
  public void noResult() throws Exception {
    //given
    SimpleEvaluationObject seo = new SimpleEvaluationObject("code", new KernelTest.SeoConfigurationFactoryMock(kernel, MessageFactorTest.commMsg(), MessageCreator.get(), new MagicCommandConfigurationMock()));
