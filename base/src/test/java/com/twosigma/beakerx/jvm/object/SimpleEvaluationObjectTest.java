...
import static com.twosigma.beakerx.jvm.object.EvaluationStatus.ERROR;
import static com.twosigma.beakerx.jvm.object.EvaluationStatus.FINISHED;
import static com.twosigma.beakerx.jvm.object.EvaluationStatus.QUEUED;
import static com.twosigma.beakerx.jvm.object.EvaluationStatus.RUNNING;
...
public class SimpleEvaluationObjectTest {
  ...
  public void setUp() throws Exception {
    ...
    kernel = new KernelTest(senderMock, MessageCreator.get(), new MagicCommandConfigurationMock());
    seo = new SimpleEvaluationObject("code", new SeoConfigurationFactoryMock(kernel, MessageCreator.get(), new MagicCommandConfigurationMock()));
  ...
  public void executionCount() throws Exception {
    //given
    //when
    SimpleEvaluationObject simpleEvaluationObject = new SimpleEvaluationObject("code", new SeoConfigurationFactoryMock(123, MessageCreator.get(), new MagicCommandConfigurationMock()));
  ...
  public void createWithParam_hasExpressionIsParamAndStatusIsQueued() throws Exception {
    //when
    SimpleEvaluationObject object = new SimpleEvaluationObject("code", new SeoConfigurationFactoryMock(kernel, MessageCreator.get(), new MagicCommandConfigurationMock()));
    //then
