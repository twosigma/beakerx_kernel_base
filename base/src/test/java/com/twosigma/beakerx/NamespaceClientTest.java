...
public class NamespaceClientTest {
  ...
  public void setUp() {
    ...
    namespaceClient = new NamespaceClient(new AutotranslationServiceTestMock(), new DefaultBeakerXJsonSerializer(), commRepository);
    kernel = new KernelTest(commRepository, MessageCreator.get(), new MagicCommandConfigurationMock());
