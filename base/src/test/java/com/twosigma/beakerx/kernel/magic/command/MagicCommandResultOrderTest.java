...
public class MagicCommandResultOrderTest {
  ...
  public static final String DOC_CONTENTS_DEMO_RESOURCES_BEAKERX_TEST_LIBRARY_JAR = "./src/test/resources/" + DEMO_JAR;
  private KernelTest kernel;
  private CodeFactory codeFactory;

  @Before
  public void setUp() throws Exception {
    this.kernel = new KernelTest("id2", new EvaluatorTest(), MessageCreator.get(), new MagicCommandConfigurationMock());
