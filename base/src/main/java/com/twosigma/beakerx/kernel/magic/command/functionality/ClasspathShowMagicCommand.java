...
public class ClasspathShowMagicCommand extends ClasspathMagicCommand {
  ...
  public ClasspathShowMagicCommand(KernelFunctionality kernel, MessageCreatorService messageCreatorService) {
  ...
  public MagicCommandOutput execute(MagicCommandExecutionParam param) {
    ...
    return new MagicCommandOutput(MagicCommandOutput.Status.OK, result.getData().toString(), MessageCreator.get());
  }
}
