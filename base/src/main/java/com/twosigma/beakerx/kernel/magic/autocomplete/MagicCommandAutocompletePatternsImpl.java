...
import com.twosigma.beakerx.kernel.magic.command.functionality.ClasspathMagicCommandInfo;
...
public class MagicCommandAutocompletePatternsImpl implements MagicCommandAutocompletePatterns {
  ...
  public MagicCommandAutocompletePatternsImpl() {
    patterns.put(ClasspathMagicCommandInfo.CLASSPATH,
            new AutocompleteNodeStatic(ClasspathMagicCommandInfo.CLASSPATH,
