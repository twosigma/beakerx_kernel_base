...
public class TimeItCellModeMagicCommand extends TimeMagicCommand {
  ...
  public TimeItCellModeMagicCommand(KernelFunctionality kernel, EvaluationObjectFactory objectFactory) {
    super(kernel, objectFactory);
  }
  ...
  public MagicCommandOutcomeItem execute(MagicCommandExecutionParam param) {
    ...
    try {
      ...
      return new MagicCommandOutput(MagicCommandOutput.Status.ERROR, e.getMessage(), MessageCreator.get());
    }
  }
}
