...
public class BashMagicCommand implements MagicCommandFunctionality {
  ...
  public MagicCommandOutcomeItem execute(MagicCommandExecutionParam param) {
    ...
    if (errorData.hasError()) {
      return new MagicCommandOutput(MagicCommandOutput.Status.ERROR, errorData.getMessage(), MessageCreator.get());
    }
    return new MagicCommandOutput(MagicCommandOutput.Status.OK, errorData.getMessage(), MessageCreator.get());
  }
