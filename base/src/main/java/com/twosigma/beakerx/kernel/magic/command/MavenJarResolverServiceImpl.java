...
public class MavenJarResolverServiceImpl implements MavenJarResolverService {
  @Override
  public MavenJarResolver.ResolverParams getParams(KernelFunctionality kernel) {
