...
public class Layout extends Widget implements LayoutInfo {
  ...
  protected HashMap<String, Object> content(HashMap<String, Object> content) {
    ...
    content.put("border", "");
    content.put("bottom", "");
    content.put(WidgetInfo.DISPLAY, getDisplay());
    content.put("flex", "");
  ...
  public void setDisplay(String display) {
    ...
    sendUpdate(WidgetInfo.DISPLAY, display);
  }
  ...
  public String getModelModuleValue() {
    return LayoutInfo.MODEL_MODULE_VALUE;
  }

  @Override
  public String getViewModuleValue() {
    return LayoutInfo.VIEW_MODULE_VALUE;
  }
  ...
  public void setDisplayNone() {
    sendUpdate(WidgetInfo.DISPLAY, "none");
  }
